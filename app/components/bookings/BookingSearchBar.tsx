    ...
    <>
      <div className="w-full max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-8 relative">
          ...
          <div className="py-8">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 bg-gradient-to-r from-gray-900 via-red-800 to-gray-900 bg-clip-text text-transparent">
        ...
        <div className="relative mb-8">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-4 md:p-6">
            <div className="flex flex-col md:flex-row gap-4 md:gap-6">
              <div className="flex-1 flex flex-col md:flex-row gap-4">
                <button
                  onClick={() => setShowCalendar(!showCalendar)}
                  className="group flex-1 px-6 py-4 text-left hover:bg-gradient-to-r hover:from-red-50 hover:to-red-100 rounded-2xl transition-all duration-300 border-2 border-transparent hover:border-red-200 hover:shadow-lg"
                >
              ...
              <div className="flex items-center justify-center">
                <Button
                  ...
                  className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white rounded-2xl w-16 h-16 md:w-20 md:h-20 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-2xl shadow-lg border-0"
                  type="button"
                >
        ...
        {showCalendar && (
          <div className="relative mb-8">
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl border border-white/20 shadow-2xl p-6 md:p-8">
              <div className="text-center space-y-3 mb-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-red-50 to-red-100 rounded-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                <div className="bg-gradient-to-r from-green-50 to-green-100 border-2 border-green-200 rounded-xl p-4 hover:shadow-lg transition-all duration-300">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 border-2 border-blue-200 rounded-xl p-4 hover:shadow-lg transition-all duration-300">
                  <div className="flex items-center gap-2 mb-2">
              ...
              <div className="flex items-center justify-between mb-8 bg-gray-50 rounded-xl p-4">
                <button
                  ...
                  className="p-3 hover:bg-white rounded-xl transition-all duration-300 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <button 
                  ...
                  className="p-3 hover:bg-white rounded-xl transition-all duration-300 hover:shadow-md"
                >
              ...
              <div className="flex flex-col lg:flex-row lg:gap-12 justify-center mb-8 gap-8">
                {/* First Month */}
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-gray-200">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto sm:ml-auto order-1 sm:order-2">
                  <button 
                    ...
                    className="w-full sm:w-auto px-6 py-3 text-gray-700 hover:text-gray-900 transition-colors border-2 border-gray-300 hover:border-gray-400 rounded-xl font-medium"
                  >
                    Close Calendar
                  </button>
                  {startDate && endDate && (
                    <Button
                      ...
                      className="w-full sm:w-auto bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-8 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                    >
                      Search Vehicles →
                    </Button>
                  )}
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 text-sm bg-gradient-to-r from-gray-50 to-gray-100 p-4 rounded-xl mt-6 border border-gray-200">
